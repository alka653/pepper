		...
		<tbody>
			<tr>
				<td style="padding-bottom:30px">
					<h2 style=";text-align:center;color:#404040;margin:0">Hola, {{ $user->nombre.' '.$user->apellido }}</h2>
				</td>
			</tr>
			<tr>
							...
							<tr>
								<td style="text-align:center">
									<span style="font-size:14px;color:#999999;font-weight:300;text-align:center">
										Gracias por registrarse en <strong>Pepper</strong>. Recuerda que el correo es {{ $user->email }} y la contraseña es <strong>12345</strong>. Ingresa ya para registrar a una mascota.
									</span>
								</td>
							</tr>
						</tbody>
