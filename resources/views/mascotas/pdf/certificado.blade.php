...
@section('content')
	...
	<div>
		<div style="width: 50%; display: inline-block;">
			...
			<ul>
				...
				<li>Acta de Acta de declaración Juramentada ante notaria, asumiendo responsabilidad ante cualquier daño ocasionado por el canino a humanos u otros animales.</li>
			</ul>
		</div>
	...
	<br/>
	<br/>
	<h4 class="text-center" style="margin-bottom: -35px;">MANUEL REINALDO DIAS GONZALEZ</h4>
